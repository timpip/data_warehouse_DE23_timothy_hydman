...
GRANT SELECT ON ALL TABLES IN SCHEMA parking_db.staging_mc TO ROLE parking_dlt_role;


GRANT CREATE TABLE ON SCHEMA parking_db.staging TO ROLE parking_dlt_role;
GRANT CREATE TABLE ON SCHEMA parking_db.staging_mc TO ROLE parking_dlt_role;


GRANT INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA parking_db.staging TO ROLE parking_dlt_role;
GRANT INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA parking_db.staging_mc TO ROLE parking_dlt_role;

--GRANT FUTURE--


GRANT SELECT ON FUTURE TABLES IN SCHEMA parking_db.staging TO ROLE parking_dlt_role;
GRANT SELECT ON FUTURE TABLES IN SCHEMA parking_db.staging_mc TO ROLE parking_dlt_role;


GRANT INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA parking_db.staging TO ROLE parking_dlt_role;
GRANT INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA parking_db.staging_mc TO ROLE parking_dlt_role;
